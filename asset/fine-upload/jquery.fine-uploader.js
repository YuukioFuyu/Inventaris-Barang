    ...
    (function() {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                messages: {
                    typeError: "{file} memiliki ekstensi yang tidak valid. Ekstensi yang valid: {extensions}.",
                    sizeError: "{file} terlalu besar, ukuran file maksimum adalah {sizeLimit}.",
                    minSizeError: "{file} terlalu kecil, ukuran file minimum adalah {minSizeLimit}.",
                    emptyError: "{file} kosong, harap pilih file lagi tanpa file ini.",
                    noFilesError: "Tidak ada file yang akan diunggah.",
                    tooManyItemsError: "Terlalu banyak item ({netItems}) yang akan diunggah. Batas item adalah {itemLimit}.",
                    maxHeightImageError: "Gambar terlalu tinggi.",
                    maxWidthImageError: "Gambar terlalu lebar.",
                    minHeightImageError: "Gambar tidak cukup tinggi.",
                    minWidthImageError: "Gambar tidak cukup lebar.",
                    retryFailTooManyItems: "Coba lagi gagal - Anda telah mencapai batas file Anda.",
                    onLeave: "File sedang diunggah, jika Anda meninggalkan sekarang, proses unggah akan dibatalkan.",
                    unsupportedBrowserIos8Safari: "Kesalahan tidak dapat diperbaiki - browser ini tidak mengizinkan unggahan file apapun karena bug serius pada Safari iOS8. Harap gunakan iOS8 Chrome sampai Apple memperbaiki masalah ini."
                },                
                retry: {
                    enableAuto: false,
                    maxAutoAttempts: 3,
