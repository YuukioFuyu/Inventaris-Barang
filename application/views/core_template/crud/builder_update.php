                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?php if ($option['input_type'] == 'input') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($input)); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                        ...
                        <?php } elseif ($option['input_type'] == 'number') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($input)); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'email') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input type="email" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($input)); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
                        <?php } elseif ($option['input_type'] == 'datetime') {?><div class="form-group ">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="<?= $input; ?>"  placeholder="<?= ucwords(clean_snake_case($input)); ?>" id="<?= $input; ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                            </div>
                            <small class="info help-block">
                            <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'date') {?><div class="form-group ">
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="<?= $input; ?>"  placeholder="<?= ucwords(clean_snake_case($input)); ?>" id="<?= $input; ?>" value="{php_open_tag_echo} set_value('{table_name}_<?= $input; ?>_name', ${table_name}-><?= $input; ?>); {php_close_tag}">
                            </div>
                            <small class="info help-block">
                            <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        ...
                        <?php } elseif ($option['input_type'] == 'address_map') {?><div class="form-group ">
                            ...
                            <?php } ?></label>
                            <div class="col-sm-8">
                                <input autocomplete="off" type="text" class="form-control" name="<?= $input; ?>" id="<?= $input; ?>" placeholder="<?= ucwords(clean_snake_case($input)); ?>" value="{php_open_tag_echo} set_value('<?= $input; ?>', ${table_name}-><?= $input; ?>); {php_close_tag}">
                                <small class="info help-block">
                                <?= $this->crud_builder->parseValidationFile($input); ?></small>
                            </div>
                        </div>
      ...
      $('.btn_save').click(function(){
       ...
       $('#{table_name}_<?= $input; ?>_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + '{table_name}/get_<?= $input; ?>_file/{php_open_tag_echo} ${table_name}->{primary_key}; {php_close_tag}',
