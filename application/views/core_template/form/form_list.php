               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success" title="export <?= ucwords(clean_snake_case($table_name)); ?>" href="{php_open_tag_echo} site_url('<?= $table_name; ?>/export'); {php_close_tag}"><i class="fa fa-file-excel-o" ></i> Export</a>
                        {php_open_tag} }) {php_close_tag}
                     </div>
