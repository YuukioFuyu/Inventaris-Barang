...
<section class="content-header">
    <h1>
        Jabatan        <small>New Jabatan</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class=""><a  href="<?= site_url('jabatan'); ?>">Jabatan</a></li>
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Jabatan</h3>
                            <h5 class="widget-user-desc">New Jabatan</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_jabatan', 
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        var form_jabatan = $('#form_jabatan');
        var data_post = form_jabatan.serializeArray();
