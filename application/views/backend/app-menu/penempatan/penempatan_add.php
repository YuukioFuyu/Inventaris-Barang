...
<section class="content-header">
    <h1>
        Penempatan        <small>Penempatan Baru</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Penempatan Baru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_penempatan"  placeholder="Tanggal Penempatan" id="tanggal_penempatan">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan pembuatan penempatan?",
            text: "Data penempatan yang akan dibuat akan terbuang.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/penempatan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
