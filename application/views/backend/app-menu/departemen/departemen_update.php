...
<section class="content-header">
    <h1>
        Departemen        <small>Edit Departemen</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Departemen</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('departemen/edit_save/'.$this->uri->segment(3)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_departemen" id="nama_departemen" placeholder="Nama Departemen" value="<?= set_value('nama_departemen', $departemen->nama_departemen); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="keterangan" name="keterangan" rows="10" cols="80"> <?= set_value('keterangan', $departemen->keterangan); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit departemen?",
            text: "Data departemen yang akan diubah tidak akan disimpan.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_departemen.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#departemen_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
