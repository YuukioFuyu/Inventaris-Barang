                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Retur Baru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_retur', 
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="retur_berkas_uuid" id="retur_berkas_uuid" type="hidden" value="<?= set_value('retur_berkas_uuid'); ?>">
                                <input class="data_file" name="retur_berkas_name" id="retur_berkas_name" type="hidden" value="<?= set_value('retur_berkas_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan pembuatan retur?",
            text: "Data retur yang akan dibuat akan terbuang.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id_berkas = $('#retur_berkas_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_berkas !== 'undefined') {
                    $('#retur_berkas_galery').fineUploader('deleteFile', id_berkas);
                }
