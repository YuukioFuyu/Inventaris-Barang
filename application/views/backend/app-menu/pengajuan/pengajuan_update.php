...
<section class="content-header">
    <h1>
        Peminjaman        <small>Edit Peminjaman</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Peminjaman</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('pengajuan/edit_save/'.$this->uri->segment(3)), [
                            'name'    => 'form_pengajuan', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="nama_barang" id="nama_barang" data-placeholder="Pilih Nama Barang" >
                                    ...
                                    <option <?=  $row->nama_barang ==  $pengajuan->nama_barang ? 'selected' : ''; ?> value="<?= $row->nama_barang ?>"><?= $row->nama_barang; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="departemen" id="departemen" data-placeholder="Pilih Departemen Peminjam" >
                                    ...
                                    <option <?=  $row->nama_departemen ==  $pengajuan->departemen ? 'selected' : ''; ?> value="<?= $row->nama_departemen ?>"><?= $row->nama_departemen; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah" value="<?= set_value('jumlah', $pengajuan->jumlah); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="lokasi" id="lokasi" data-placeholder="Pilih Lokasi" >
                                    ...
                                    <option <?=  $row->nama_lokasi ==  $pengajuan->lokasi ? 'selected' : ''; ?> value="<?= $row->nama_lokasi ?>"><?= $row->nama_lokasi; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <textarea id="keperluan" name="keperluan" rows="10" cols="80"> <?= set_value('keperluan', $pengajuan->keperluan); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit peminjaman?",
            text: "Data peminjaman yang akan diubah tidak akan disimpan.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_pengajuan.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#pengajuan_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
