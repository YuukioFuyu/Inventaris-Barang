...
<section class="content-header">
    <h1>
        Pengembalian        <small>Pengembalian Baru</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Pengembalian Baru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan pembuatan pengembalian?",
            text: "Data pengembalian yang akan dibuat akan terbuang.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/pengembalian/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
