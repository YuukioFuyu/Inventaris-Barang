                  ...
                  <div class="form-horizontal" name="form_page" id="form_page" >
                    ...
                    <div class="form-group ">
                        ...
                        if ($page->type == 'backend') {
                          echo anchor('page/detail/'.$page->link, '<i class="fa fa-chain"></i> ', ['target' => 'blank']);
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit page (Ctrl+e)" href="<?= site_url('page/edit/'.$page->id); ?>"><i class="fa fa-edit" ></i> Edit Page</a>
                        <?php }) ?>
                        <a class="btn btn-flat btn-default btn_action" id="btn_back" title="back (Ctrl+x)" href="<?= site_url('page/'); ?>"><i class="fa fa-undo" ></i> Go Page List</a>
                     </div>
