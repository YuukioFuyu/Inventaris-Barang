                                   ...
                                   <?= form_open('', [
                                    ...
                                    <div class="form-group  wrapper-options-crud">
                                        ...
                                        <div class="col-sm-8">
                                                ...
                                                <label>
                                                <input type="radio" class="flat-red" name="type" value="frontend" checked> frontend                                    
                                                </label>
                                                </div>
                                                <div class="col-sm-2 padding-left-0">
                                                <label>
                                                <input type="radio" class="flat-red" name="type" value="backend"> backend                                    
                                                </label>
                                                </div>
                                                </select>
