...
function domo(){
   ...
   $('*').bind('keydown', 'Ctrl+a', function assets() {
       window.location.href = BASE_URL + '/Karyawan/add';
       return false;
   });
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new Karyawan (Ctrl+a)" href="<?=  site_url('karyawan/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New Data Peminjam</a>
                        <?php }) ?>
                        <?php is_allowed('karyawan_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export Karyawan" href="<?= site_url('karyawan/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export XLS</a>
                        <?php }) ?>
                        <?php is_allowed('karyawan_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export pdf Karyawan" href="<?= site_url('karyawan/export_pdf'); ?>"><i class="fa fa-file-pdf-o" ></i> Export PDF</a>
                        <?php }) ?>
                     </div>
                  ...
                  <form name="form_karyawan" id="form_karyawan" action="<?= base_url('karyawan/index'); ?>">
                     ...
                     <?php foreach($karyawans as $karyawan): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('karyawan/view/' . $karyawan->id_karyawan); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> View
                              <?php }) ?>
                              <?php is_allowed('karyawan_update', function($option_karyawan) use ($karyawan){?>
                              <a href="<?= site_url('karyawan/edit/' . $karyawan->id_karyawan); ?>" class="label-default"><i class="fa fa-edit "></i> Update</a>
                              <?php }) ?>
                              <?php is_allowed('karyawan_delete', function($option_karyawan) use ($karyawan){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('karyawan/delete/' . $karyawan->id_karyawan); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Remove</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('karyawan');?>" title="reset filters">
    ...
    $('#apply').click(function(){
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/karyawan/delete?' + serialize_bulk;      
            }
          });
