...
<section class="content-header">
    <h1>
        Data Peminjam        <small>New Data Peminjam</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Data Peminjam</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_karyawan', 
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nik" id="nik" placeholder="Nik" value="<?= set_value('nik'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="jabatan" id="jabatan" data-placeholder="Select Jabatan" >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('jabatan') as $row): ?>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        var data_post = form_karyawan.serializeArray();
        ...
        $.ajax({
          url: BASE_URL + '/karyawan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
