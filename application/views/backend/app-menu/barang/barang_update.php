            ...
            <div class="box box-primary">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('barang/edit_save/'.$this->uri->segment(3)), [
                            'name'    => 'form_barang', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="kategori" id="kategori" data-placeholder="Pilih Kategori" >
                                    ...
                                    <option <?=  $row->katerogi ==  $barang->kategori ? 'selected' : ''; ?> value="<?= $row->katerogi ?>"><?= $row->katerogi; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                ...
                                <small class="info help-block">
                                <b>Format file harus</b> JPG, JPEG, GIF atau PNG.</small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit barang?",
            text: "Data barang yang akan diubah tidak akan disimpan.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
       ...
       $('#barang_gambar_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'barang/get_gambar_file/<?= $barang->id_barang; ?>',
