...
function domo(){
   ...
   $('*').bind('keydown', 'Ctrl+a', function assets() {
       window.location.href = BASE_URL + '/Rest/add';
       return false;
   });
            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new Rest (Ctrl+a)" href="<?=  site_url('rest/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New Rest</a>
                        <?php }) ?>
                        <?php is_allowed('rest_export', function(){?>
                        <a class="btn btn-flat btn-success" title="export Rest" href="<?= site_url('rest/export'); ?>"><i class="fa fa-file-excel-o" ></i> Export</a>
                        <?php }) ?>
                  ...
                  <form name="form_rest" id="form_rest" action="<?= base_url('rest/index'); ?>">
                     ...
                     <?php foreach($rests as $rest): ?>
                        <tr>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('rest/view/' . $rest->id); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> View
                              <?php }) ?>
                               <?php is_allowed('rest_update', function($option_rest) use ($rest){?>
                              <a href="<?= site_url('rest/edit/' . $rest->id); ?>" class="label-default"><i class="fa fa-edit "></i> Update</a>
                              <?php }) ?>
                              <?php is_allowed('rest_delete', function($option_rest) use ($rest){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('rest/delete/' . $rest->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Remove</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="col-sm-1 padd-left-0 ">
                        <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('rest');?>" title="reset filters">
     ...
     $('#apply').click(function() {
         ...
         if (bulk.val() == 'delete') {
             swal({
                 ...
                 function(isConfirm) {
                     if (isConfirm) {
                         document.location.href = BASE_URL + '/rest/delete?' + serialize_bulk;
                     }
                 });
