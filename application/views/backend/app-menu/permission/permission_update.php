            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">Edit Izin</h5>
                     <hr>
                  </div>
                  
                     <?= form_open('permission/edit_save/'.$this->uri->segment(3), [
                     ...
                     <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <input type="text" class="form-control" name="name" id="name" placeholder="Nama" value="<?= set_value('name', $permission->name); ?>">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <input type="text" class="form-control" name="definition" id="definition" placeholder="Keterangan" value="<?= set_value('definition', $permission->definition); ?>">
...
<script>
   $(document).ready(function() {
    $('#btn_cancel').click(function() {
        swal({
                title: "Batalkan edit izin?",
                text: "Data izin yang akan diubah tidak akan disimpan.",
                type: "warning",
