...
<section class="content-header">
    <h1>
        Lokasi        <small>Lokasi Baru</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Lokasi Baru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_lokasi', 
                            ...
                            <label for="nama_lokasi" class="col-sm-2 control-label">Nama Lokasi 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan pembuatan lokasi?",
            text: "Data lokasi yang akan dibuat akan terbuang.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        var form_lokasi = $('#form_lokasi');
        var data_post = form_lokasi.serializeArray();
