...
<section class="content-header">
    <h1>
        Lokasi        <small>Edit Lokasi</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Lokasi</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('lokasi/edit_save/'.$this->uri->segment(3)), [
                            'name'    => 'form_lokasi', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_lokasi" id="nama_lokasi" placeholder="Nama Lokasi" value="<?= set_value('nama_lokasi', $lokasi->nama_lokasi); ?>">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="departemen" id="departemen" data-placeholder="Pilih Departemen" >
                                    ...
                                    <option <?=  $row->nama_departemen ==  $lokasi->departemen ? 'selected' : ''; ?> value="<?= $row->nama_departemen ?>"><?= $row->nama_departemen; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit lokasi?",
            text: "Data lokasi yang akan diubah tidak akan disimpan.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#lokasi_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
