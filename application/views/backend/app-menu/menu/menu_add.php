               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <input type="hidden" value="<?= $menu_type_id; ?>" name="menu_type_id">
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen  chosen-select-deselect" name="parent" id="parent" tabi-ndex="5" data-placeholder="Select Parent">
                            <option value=""></option>
                            <?php foreach (db_get_all_data('menu', ['menu_type_id' =>  $this->model_menu->get_id_menu_type_by_flag($this->uri->segment(3))]) as $row): ?>
                    ...
                    <div class="form-group menu-only">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen  chosen-select-deselect" name="icon_color" id="icon_color" tabi-ndex="5" data-placeholder="Select Color">
