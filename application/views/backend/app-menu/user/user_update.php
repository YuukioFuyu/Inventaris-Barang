            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">Edit Pengguna</h5>
                     <hr>
                  </div>
                  <?= form_open(base_url('user/edit_save/'.$this->uri->segment(3)), [
                    'name'    => 'form_user', 
                   ...
                   <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen-select" name="group[]" id="group" multiple data-placeholder="Pilih Grup">
