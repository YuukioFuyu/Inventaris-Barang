...
<section class="content-header">
    <h1>
        Pengadaan        <small>Edit Pengadaan</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Pengadaan</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('pengadaan/edit_save/'.$this->uri->segment(3)), [
                            'name'    => 'form_pengadaan', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="jenis_pengadaan" id="jenis_pengadaan" data-placeholder="Pilih Jenis Pengadaan" >
                                    ...
                                    <option <?=  $row->jenis_pengadaan ==  $pengadaan->jenis_pengadaan ? 'selected' : ''; ?> value="<?= $row->jenis_pengadaan ?>"><?= $row->jenis_pengadaan; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="nama_barang" id="nama_barang" data-placeholder="Pilih Nama Barang" >
                                    ...
                                    <option <?=  $row->nama_barang ==  $pengadaan->nama_barang ? 'selected' : ''; ?> value="<?= $row->nama_barang ?>"><?= $row->nama_barang; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="supplier" id="supplier" data-placeholder="Pilih Supplier" >
                                    ...
                                    <option <?=  $row->nama_supplier ==  $pengadaan->supplier ? 'selected' : ''; ?> value="<?= $row->nama_supplier ?>"><?= $row->nama_supplier; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="harga" id="harga" placeholder="Harga" value="<?= set_value('harga', $pengadaan->harga); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah" value="<?= set_value('jumlah', $pengadaan->jumlah); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_pengadaan"  placeholder="Tanggal Pengadaan" id="tanggal_pengadaan" value="<?= set_value('pengadaan_tanggal_pengadaan_name', $pengadaan->tanggal_pengadaan); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="deskripsi_barang" name="deskripsi_barang" rows="10" cols="80"> <?= set_value('deskripsi_barang', $pengadaan->deskripsi_barang); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="keterangan" name="keterangan" rows="10" cols="80"> <?= set_value('keterangan', $pengadaan->keterangan); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit pengadaan?",
            text: "Data pengadaan yang akan diubah tidak akan disimpan.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_pengadaan.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#pengadaan_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
