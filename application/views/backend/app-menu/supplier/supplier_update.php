...
<section class="content-header">
    <h1>
        Supplier        <small>Edit Supplier</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Supplier</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('supplier/edit_save/'.$this->uri->segment(3)), [
                            'name'    => 'form_supplier', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_supplier" id="nama_supplier" placeholder="Nama Supplier" value="<?= set_value('nama_supplier', $supplier->nama_supplier); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="no_telp" id="no_telp" placeholder="Nomor Telepon" value="<?= set_value('no_telp', $supplier->no_telp); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="alamat_lengkap" name="alamat_lengkap" rows="10" cols="80"> <?= set_value('alamat_lengkap', $supplier->alamat_lengkap); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit supplier?",
            text: "Data supplier yang akan diubah tidak akan disimpan.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#supplier_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
