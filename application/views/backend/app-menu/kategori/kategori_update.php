...
<section class="content-header">
    <h1>
        Kategori        <small>Edit Kategori</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Kategori</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('kategori/edit_save/'.$this->uri->segment(3)), [
                            'name'    => 'form_kategori', 
                            ...
                            <label for="katerogi" class="col-sm-2 control-label">Katerogi 
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="katerogi" id="katerogi" placeholder="Katerogi" value="<?= set_value('katerogi', $kategori->katerogi); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="keterangan" name="keterangan" rows="10" cols="80"> <?= set_value('keterangan', $kategori->keterangan); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan edit kategori?",
            text: "Data kategori yang akan diubah tidak akan disimpan.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#kategori_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
