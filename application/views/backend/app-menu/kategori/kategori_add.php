...
<section class="content-header">
    <h1>
        Kategori        <small>Kategori Baru</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Kategori Baru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_kategori', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="katerogi" id="katerogi" placeholder="Katerogi" value="<?= set_value('katerogi'); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan pembuatan kategori?",
            text: "Data kategori yang akan dibuat akan terbuang.",
            type: "warning",
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/kategori/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
