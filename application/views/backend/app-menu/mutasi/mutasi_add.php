...
<section class="content-header">
    <h1>
        Mutasi        <small>Mutasi Baru</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Mutasi Baru</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_mutasi', 
                            ...
                            <label for="id_penempatan" class="col-sm-2 control-label">ID Penempatan Awal
                            <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="id_penempatan" id="id_penempatan" data-placeholder="Pilih Id Penempatan" >
                                    ...
                                    <option value="<?= $row->lokasi ?>"><?= $row->id_penempatan; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="tanggal_mutasi"  placeholder="Tanggal Mutasi" id="tanggal_mutasi">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
            title: "Batalkan pembuatan mutasi?",
            text: "Data mutasi yang akan dibuat akan terbuang.",
            type: "warning",
